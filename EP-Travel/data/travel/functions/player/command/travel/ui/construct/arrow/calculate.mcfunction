...
execute if score #ep.ui.value ep.variable matches 5 if score #ep.terminal.teleport_enabled5 ep.variable matches 0 run function travel:player/command/travel/ui/construct/arrow/recalculate
