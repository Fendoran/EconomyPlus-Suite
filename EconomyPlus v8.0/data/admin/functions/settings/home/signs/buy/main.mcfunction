...
execute positioned ^ ^0.0 ^ run function admin:settings/home/signs/buy/text/construct
execute positioned ^ ^-0.75 ^ run function admin:settings/home/signs/buy/type/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "Choose a buy sign type.", "color": "#ffffff"}]
