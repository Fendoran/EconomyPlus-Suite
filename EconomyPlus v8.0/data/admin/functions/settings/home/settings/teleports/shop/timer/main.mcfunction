...
execute positioned ^0 ^-1.9 ^ run function admin:settings/home/settings/teleports/shop/cost/back/construct
scoreboard players operation #ep.ui.value ep.variable = #ep.terminal.teleport_cooldown ep.variable
execute positioned ^0 ^-1.10 ^ run function admin:settings/home/settings/teleports/shop/timer/construct
