...
execute positioned ^0 ^-1.9 ^ run function admin:settings/home/settings/teleports/bank/cost/back/construct
scoreboard players operation #ep.ui.value ep.variable = #ep.terminal.teleport_cooldown4 ep.variable
execute positioned ^0 ^-1.10 ^ run function admin:settings/home/settings/teleports/bank/timer/construct
