...
execute positioned ^0 ^-1.9 ^ run function admin:settings/home/settings/teleports/auction/cost/back/construct
scoreboard players operation #ep.ui.value ep.variable = #ep.terminal.teleport_cooldown3 ep.variable
execute positioned ^0 ^-1.10 ^ run function admin:settings/home/settings/teleports/auction/timer/construct
