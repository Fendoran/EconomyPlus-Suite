...
scoreboard players operation #ep.ui.value ep.variable = #ep.terminal.teleport_cost3 ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/teleports/auction/cost/construct
