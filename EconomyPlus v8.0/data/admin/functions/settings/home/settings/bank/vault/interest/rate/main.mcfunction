...
scoreboard players operation #ep.ui.value ep.variable = #ep.enum.bank.interest_rate ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/bank/vault/interest/rate/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "The interest rate used for bank interest.", "color": "#ffffff"}]
