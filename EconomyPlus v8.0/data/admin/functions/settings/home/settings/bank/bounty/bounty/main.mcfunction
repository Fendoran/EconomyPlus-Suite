...
scoreboard players operation #ep.ui.value ep.variable = #ep.bounty_percent ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/bank/bounty/bounty/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "This value is the percent of the loot that is re-calculated into the player bounty.", "color": "#ffffff"}]
