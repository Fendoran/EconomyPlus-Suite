...
scoreboard players operation #ep.ui.value ep.variable = #ep.loan.interest_rate ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/bank/vault/loan/interest_rate/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "This is the interest rate applied when a player takes a loan.  This value is only applied once.", "color": "#ffffff"}]
