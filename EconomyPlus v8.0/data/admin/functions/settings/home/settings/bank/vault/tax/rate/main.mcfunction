...
scoreboard players operation #ep.ui.value ep.variable = #ep.tax.rate ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/bank/vault/tax/rate/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "The percent that is taxed out of your income.", "color": "#ffffff"}]
