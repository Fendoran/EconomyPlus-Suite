...
scoreboard players operation #ep.ui.value ep.variable = #ep.debt.interval ep.variable
execute positioned ^0 ^-1.10 ^ run function admin:settings/home/settings/bank/vault/vault/debt_interval/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "This is the interest rate applied to a player occurs on this value of interval.", "color": "#ffffff"}]
