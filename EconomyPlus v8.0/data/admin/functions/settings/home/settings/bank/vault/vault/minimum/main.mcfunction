...
scoreboard players operation #ep.ui.value ep.variable = #ep.vault_minimum ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/bank/vault/vault/minimum/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "This is the lowest possible value the Vault can be at.  If it goes below, it will automatically inflate back to this value.", "color": "#ffffff"}]
