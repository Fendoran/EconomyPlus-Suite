...
scoreboard players operation #ep.ui.value ep.variable = #ep.bank.interest.interval ep.variable
execute positioned ^0 ^-1.10 ^ run function admin:settings/home/settings/bank/vault/interest/interval/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "This is how often the interest rate is applied to the player's bank.", "color": "#ffffff"}]
