...
scoreboard players operation #ep.ui.value ep.variable = #ep.loan.max_loan ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/bank/vault/loan/max/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "This is the max value that a loan can be.", "color": "#ffffff"}]
