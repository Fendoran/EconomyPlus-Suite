...
scoreboard players operation #ep.ui.value ep.variable = #ep.tax.min_amount ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/bank/vault/tax/min_income/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "The amount you must earn in a period before getting taxed.", "color": "#ffffff"}]
