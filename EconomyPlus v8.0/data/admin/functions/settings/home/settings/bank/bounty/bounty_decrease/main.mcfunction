...
scoreboard players operation #ep.ui.value ep.variable = #ep.bounty_decrease ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/bank/bounty/bounty_decrease/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "This value is how much per hour the bounty is lowered.", "color": "#ffffff"}]
