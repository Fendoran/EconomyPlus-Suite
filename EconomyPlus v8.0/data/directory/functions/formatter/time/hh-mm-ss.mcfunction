...
execute if score #ep.hours ep.variable >= SINGLE_DIGIT ep.variable run data modify block 29999999 0 29999999 Text2 set value '[{"score": {"name": "#ep.hours", "objective": "ep.variable"}, "color": "red"}]'
execute if score #ep.hours ep.variable < SINGLE_DIGIT ep.variable run data modify block 29999999 0 29999999 Text2 set value '[{"text": "0", "color": "red"}, {"score": {"name": "#ep.hours", "objective": "ep.variable"}, "color": "red"}]'

execute if score #ep.minutes ep.variable >= SINGLE_DIGIT ep.variable run data modify block 29999999 0 29999999 Text3 set value '[{"score": {"name": "#ep.minutes", "objective": "ep.variable"}, "color": "red"}]'
execute if score #ep.minutes ep.variable < SINGLE_DIGIT ep.variable run data modify block 29999999 0 29999999 Text3 set value '[{"text": "0", "color": "red"}, {"score": {"name": "#ep.minutes", "objective": "ep.variable"}, "color": "red"}]'

execute if score #ep.seconds ep.variable >= SINGLE_DIGIT ep.variable run data modify block 29999999 0 29999999 Text4 set value '[{"score": {"name": "#ep.seconds", "objective": "ep.variable"}, "color": "red"}]'
execute if score #ep.seconds ep.variable < SINGLE_DIGIT ep.variable run data modify block 29999999 0 29999999 Text4 set value '[{"text": "0", "color": "red"}, {"score": {"name": "#ep.seconds", "objective": "ep.variable"}, "color": "red"}]'
