...
setblock 29999999 0 29999999 minecraft:oak_sign{Text1: '[{"nbt":"currency_icon","storage":"ep:config","color":"#D4AF37"}, {"score": {"name": "#ep.price", "objective": "ep.variable"}, "color": "#FFD700"}, {"text": " for ", "color": "#C0C0C0"}, {"score": {"name": "#ep.quantity", "objective": "ep.variable"}, "color": "#808080"}, {"text": " ", "color": "#C0C0C0"}, {"nbt": "output_name", "storage": "ep:memory", "interpret": true, "color": "#32CD32"}]'}
