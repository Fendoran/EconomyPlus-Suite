...
execute unless score #ep.success ep.variable = #ep.enum.bool.true ep.state run function directory:market/use_sell/checker/pass
execute if score #ep.success ep.variable = #ep.enum.bool.true ep.state run function directory:market/use_sell/checker/fail

execute if data storage ep:memory raw_list[] run function directory:market/use_sell/checker/loop
