setblock 29999999 0 29999999 minecraft:oak_sign{Text1: '[{"text": "-", "color": "#f13b54"}, {"text": "$", "color": "#f13b54"}, {"score": {"name": "#ep.transaction", "objective": "ep.variable"}, "color": "#f13b54"}]'}
