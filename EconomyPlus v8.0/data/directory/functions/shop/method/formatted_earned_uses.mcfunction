...
data modify block 29999999 255 29999999 Text1 set value '[{"text":"Stock: ","color":"#ffffff"},{"text":"$","color":"#D4AF37"},{"score":{"name":"#ep.price","objective":"ep.variable"},"color":"#FFD700"}]'
