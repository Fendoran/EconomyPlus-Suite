...
title @s actionbar [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "You got ", "color": "#C0C0C0"}, {"nbt":"currency_icon","storage":"ep:config","color":"#D4AF37"}, {"score": {"name": "#ep.reward_value", "objective": "ep.variable"}, "color": "#FFD700"}, {"text": " as a playtime reward", "color": "#C0C0C0"}]
