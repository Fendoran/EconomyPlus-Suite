...
execute if score @s ep.bank < @s ep.autopay run function directory:player/event/debt/message/fail_autopay
execute if score @s ep.bank >= @s ep.autopay run function directory:player/event/debt/success_autopay
