...
tellraw @s [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "Autopay has paid ", "color": "#C0C0C0"}, {"nbt":"currency_icon","storage":"ep:config","color":"#D4AF37"}, {"score": {"name": "#ep.autopay", "objective": "ep.variable"}, "color": "#FFD700"}, {"text": " towards your debt.", "color": "#C0C0C0"}]
