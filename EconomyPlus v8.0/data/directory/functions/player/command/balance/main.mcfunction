...
tellraw @s [{"text": " "}, {"text": "Wallet: ", "color": "#70b9e0"}, {"text": "$", "color": "#D4AF37"}, {"score": {"name": "@s", "objective": "ep.money"}, "color": "#FFD700"}]
...
execute if score #ep.state ep.state matches 0 run tellraw @s [{"text": " "}, {"text": "Bank: ", "color": "#70b9e0"}, {"text": "$", "color": "#D4AF37"}, {"score": {"name": "@s", "objective": "ep.bank"}, "color": "#FFD700"}]
execute if score #ep.state ep.state matches 1 run tellraw @s [{"text": " "}, {"text": "Bank: ", "color": "#70b9e0"}, {"text": "$", "color": "#D4AF37"}, {"score": {"name": "@s", "objective": "ep.bank"}, "color": "#FFD700"}, {"text":" +","color":"#32CD32"}, {"score": {"name": "#ep.enum.bank.interest_rate", "objective": "ep.variable"}, "color": "#32CD32"}, {"text":"%","color":"#32CD32"}]
...
execute unless score @s ep.debt matches 0 run tellraw @s [{"text": "\n "}, {"text": "Debt: ", "color": "#dc9f72"}, {"text": "$", "color": "#D4AF37"}, {"score": {"name": "#ep.debt", "objective": "ep.variable"}, "color": "#FFD700"}, {"text":" +","color":"#f13b54"}, {"score": {"name": "#ep.debt.rate", "objective": "ep.variable"}, "color": "#f13b54"}, {"text": "%", "color": "#f13b54"}]
...
execute if score @s ep.bounty matches 1.. run tellraw @s [{"text": " "}, {"text": "Bounty: ", "color": "#dc9f72"}, {"text": "$", "color": "#D4AF37"}, {"score": {"name": "@s", "objective": "ep.bounty"}, "color": "#FFD700"}, {"text":" -","color":"#32CD32"}, {"text": "$", "color": "#32CD32"}, {"score": {"name": "#ep.bounty_decrease", "objective": "ep.variable"}, "color": "#32CD32"}]
