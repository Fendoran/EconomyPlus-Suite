...
tellraw @a [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"nbt": "highest_bidder.name", "storage": "ep:auction", "interpret": true, "color": "#ffffff"}, {"text": " bidded ", "color": "#C0C0C0"}, {"text": "$", "color": "#D4AF37"}, {"nbt": "highest_bidder.bid", "storage": "ep:auction", "color": "#FFD700"}]
