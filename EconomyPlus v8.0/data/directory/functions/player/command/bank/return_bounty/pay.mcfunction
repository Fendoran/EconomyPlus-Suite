...
tellraw @s [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "You payed off your bounty with ", "color": "#FFF954"}, {"text": "$", "color": "#D4AF37"}, {"score": {"name": "#ep.variable", "objective": "ep.variable"}, "color": "#FFD700"}]
