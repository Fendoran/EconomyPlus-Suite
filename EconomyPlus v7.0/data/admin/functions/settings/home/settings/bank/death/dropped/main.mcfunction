...
scoreboard players operation #ep.ui.value ep.variable = #ep.dead.drop ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/bank/death/dropped/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "The percent the player drops that can be recovered", "color": "#ffffff"}]
