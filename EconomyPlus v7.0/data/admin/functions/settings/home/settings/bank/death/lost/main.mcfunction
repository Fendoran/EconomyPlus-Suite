...
scoreboard players operation #ep.ui.value ep.variable = #ep.dead.void ep.variable
execute positioned ^0 ^-0.83 ^ run function admin:settings/home/settings/bank/death/lost/construct
...
tellraw @p[tag=ep.caster,tag=!ep.ignore.help] [{"text":"\u276cEP\u276d","color":"#D4AF37"}, {"text": " "}, {"text": "The amount the player permanently loses (sent to vault)", "color": "#ffffff"}]
