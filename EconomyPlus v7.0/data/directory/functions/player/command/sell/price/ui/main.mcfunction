...
execute positioned ^0 ^-1 ^ run function directory:terminal/ui/button/back/construct
scoreboard players operation #ep.ui.value ep.variable = #ep.ui.default ep.variable
execute positioned ^0 ^0 ^ run function directory:player/command/sell/price/ui/construct
execute positioned ^0 ^0 ^ run function directory:player/command/sell/item/ui/marker
