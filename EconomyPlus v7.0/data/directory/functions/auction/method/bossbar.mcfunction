...
bossbar set ep:auction name [{"text": "Auction: ", "color": "red"}, {"score": {"name": "#ep.time_left", "objective": "ep.variable"}, "color": "#ffffff"}, {"text": "s", "color": "#ffffff"}, {"text": " - ", "color": "#C0C0C0"}, {"text": "$", "color": "#D4AF37"}, {"nbt": "highest_bidder.bid", "storage": "ep:auction", "interpret": true, "color": "#FFD700"}]
